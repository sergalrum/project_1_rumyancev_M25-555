...
ROOMS = {
    ...
    'treasure_room': {
        'description': 'Комната, на столе большой сундук. Дверь заперта — нужен особый \
            ключ.',
        'exits': {'south': 'hall'},
    ...
    'chapel': {
        'description': 'Древняя часовня. В центре — алтарь с горящими свечами. \
            В воздухе витает запах ладана.',
